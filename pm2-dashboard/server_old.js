...
app.get('/', async (req, res) => {
  try {
    ...
    const allowedNames = ['dual-message-board', 'message-board', 'time-viewer'];
    ...
    const urlMap = {
      'dual-message-board': 'http://messageboard-svr-dgt1-1.prod.letsdowonders.io:3002/index.html',
      'message-board': 'http://messageboard-svr-dgt1-1.prod.letsdowonders.io:3000/viewer.html',
      'time-viewer': 'http://messageboard-svr-dgt1-1.prod.letsdowonders.io:3001/time.html'
    };
