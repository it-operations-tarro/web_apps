...
// ✅ Create playlist (admin.html uses POST /api/playlists)
...
// ✅ Delete playlist (admin.html uses DELETE /api/playlists/:name)
...
// ✅ Rename playlist (admin.html uses PUT /api/playlists/:oldName)
app.put('/api/playlists/:oldName', (req, res) => {
  ...
  // Rename inside playlist.json if it exists
...
// ✅ Upload files (admin.html uses POST /api/playlists/:playlist/upload)
app.post('/api/playlists/:playlist/upload', upload.array('files'), (req, res) => {
  ...
  // Update playlist.json after upload
...
// ✅ Trigger viewer (admin.html uses POST /api/playlists/:playlist/trigger)
